          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
            ...
            <div className="p-6 space-y-4 text-sm text-slate-600 leading-relaxed">
              ...
              <ul className="list-decimal pl-5 space-y-3 font-medium text-slate-700">
                <li>Ở góc trên cùng bên phải của khu vực Code (cạnh nút <strong>Publish</strong> và biểu tượng <strong>Cài đặt ⚙️</strong>), bạn sẽ thấy một <strong>biểu tượng tải xuống (mũi tên trỏ xuống)</strong>. Hãy nhấn vào đó để tải toàn bộ mã nguồn về máy (file ZIP).</li>
                ...
                <li>Nhấn vào nút <strong>Load unpacked (Tải tiện ích đã giải nén)</strong> và chọn thư mục <code className="bg-slate-100 px-1.5 py-0.5 rounded text-blue-600">dist</code> nằm bên trong thư mục vừa build.</li>
              </ul>
            </div>
